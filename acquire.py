...
def get_german_power_data(use_cache=True):
    '''
    This function takes in no arguements. It checks for german_power.csv
    If that file doesnt exists it gathers the data using the API and creates a dataframe.
    '''
